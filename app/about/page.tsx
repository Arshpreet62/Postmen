...
export default function About() {
  return (
    <div className="min-h-screen bg-linear-to-br from-white via-slate-50 to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      {/* Header */}
      <nav className="sticky top-0 z-50 bg-white dark:bg-slate-900 border-b-2 border-slate-300 dark:border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <Link
            href="/"
            className="px-4 py-2 text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white transition-colors"
          >
            Back Home
          </Link>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <section className="mb-20 glass rounded-2xl p-12">
          <div className="flex items-start gap-4 mb-6">
            <RxTarget className="w-8 h-8 text-indigo-600 shrink-0 mt-1" />
            <div>
              ...
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                ...
                efficient. Postmen was created to eliminate the friction in API
                development. Whether you're building a microservice, integrating
                third-party APIs, or debugging a production issue, Postmen
                provides the tools you need without the bloat.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass p-8 rounded-xl space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Modern design that feels intuitive and delightful to use every
                day.
              </p>
            </div>
            ...
            <div className="glass p-8 rounded-xl space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Your data is private. We use end-to-end encryption and never
                store responses.
              </p>
            </div>
          </div>
        ...
        <section className="mb-20 glass rounded-2xl p-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={tech}
                className="bg-slate-100 dark:bg-slate-800 rounded-lg p-4 text-center font-semibold text-slate-700 dark:text-slate-300"
              >
                {tech}
              </div>
            ))}
        ...
        <section className="text-center space-y-8">
          ...
          <div className="flex justify-center gap-6">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-lg hover:scale-105 transition-transform font-semibold"
            >
